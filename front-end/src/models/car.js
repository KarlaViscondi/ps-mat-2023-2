...
const Car = z.object({
    ...
    selling_date: 
        ...
        .nullable(), // não esta identificando o campo data sem clicar e digitar algo nele (?)
    
    selling_price: 
        z.coerce.number()
        .min(2000, { message: 'O preço do carro deve ser de pelo menos 2000 R$' })
        .nullable(), // nao está aceitando null (?)
    
    customer_id: 
        z.coerce.number()
        .int()
        .positive({ message: 'Selecione "nenhum cliente" ou o nome do cliente que comprou o carro' })
        .nullable() // obrigatoriamente eu tenho que "selecionar" "nenhum cliente" para ele identificar que é null 
